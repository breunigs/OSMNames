CREATE INDEX IF NOT EXISTS osm_linestring_normalized_name ON osm_linestring(normalized_name) WITH (fillfactor = 100); --&
CREATE INDEX IF NOT EXISTS osm_linestring_normalized_name_trgm ON osm_linestring USING GIN(normalized_name gin_trgm_ops); --&
CREATE INDEX IF NOT EXISTS osm_linestring_geometry ON osm_linestring USING GIST(geometry) WITH (fillfactor = 100); --&
CREATE INDEX IF NOT EXISTS osm_housenumber_geometry_center ON osm_housenumber USING GIST(geometry_center) WITH (fillfactor = 100); --&
